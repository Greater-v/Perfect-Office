                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                                ...
                                @if(auth()->check())
                                    <div class="d-flex flex-column">
                                        ...
                                        @php
                                            ...
                                            $maxEmailLength = 20; // Adjust this value as needed
                                            $displayEmail = strlen($email) > $maxEmailLength ? substr($email, 0, $maxEmailLength) . '...' : $email;
                                        @endphp
                                        <a href="#" class="fw-bold text-muted text-hover-primary fs-7" title="{{ $email }}">{{ $displayEmail }}</a>
                                    </div>
                                @endif
                        ...
                        <div class="menu-item px-5">
                            <!-- Profile Form -->
                            <form id="profile-form" method="get" action="{{ route('profile.edit') }}" style="display: none;">
                            </form>
                            <a href="#" class="menu-link px-5" onclick="event.preventDefault(); document.getElementById('profile-form').submit();">My Profile</a>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            ...
                            <a href="#" class="menu-link px-5" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Log Out</a>
                        </div>
